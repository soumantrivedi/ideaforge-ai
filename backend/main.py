...
async def lifespan(app: FastAPI):
    ...
    if db_connected:
        ...
        # Note: Database migrations are run as separate Kubernetes jobs, not in the backend application
        # This keeps migrations independent and avoids issues with backend deployment
    else:
